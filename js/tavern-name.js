...
function tavernGen() {
		...
		rnd2 = Math.floor(Math.random() * tnm3.length);

		rndhex=rnd;
		rndemoji=rnd2;
		var coloration=tnm2[rndhex];
		var emojipic=tnm4[rndemoji];
		var hexbg = invertColor(coloration);
		// elem.style.color = coloration;
		var name = tnm1[rnd] + " " + tnm3[rnd2] + " " + emojipic;
//////INVERT COLOR/////////

///////////////////////////

var elem = document.getElementById('tavern-name')
elem.style.backgroundColor = hexbg;		
elem.style.color = coloration;
